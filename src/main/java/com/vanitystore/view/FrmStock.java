...
public class FrmStock extends javax.swing.JDialog {
   ...
   /**
     * Creates new form FrmStock
     */
   public FrmStock(com.vanitystore.view.FrmDashboard parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public void setDefaultCloseOperation(int operation) {
        // Si NetBeans intenta meter EXIT_ON_CLOSE, lo obligamos a usar DISPOSE_ON_CLOSE
        if (operation == javax.swing.WindowConstants.EXIT_ON_CLOSE) {
    ...
    private void initComponents() {
        ...
        tblStock.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Talla", "Color", "Precio Unitario", "Cantidad disponible"
            }
        ));
